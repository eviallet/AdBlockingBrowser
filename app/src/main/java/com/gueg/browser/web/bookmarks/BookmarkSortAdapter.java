...
import com.gueg.browser.thumbnails.ItemTouchHelperListener;
import com.gueg.browser.R;

import java.util.ArrayList;
import java.util.Collections;

public class BookmarkSortAdapter extends RecyclerView.Adapter<BookmarkSortAdapter.ViewHolder> implements ItemTouchHelperListener {
    ...
    public BookmarkSortAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_bookmarksort, parent, false);
