...
public class BookmarksCardsAdapter extends RecyclerView.Adapter<BookmarksCardsAdapter.ViewHolder>{
    ...
    public BookmarksCardsAdapter(ArrayList<Bookmark> list) {
        mList = list;
    }
    ...
    public BookmarksCardsAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_bookmarkcard, parent, false);
